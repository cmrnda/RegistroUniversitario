...
public interface IEstudianteService { // Define la interfaz IEstudianteService
     ...
     */
    List<Materia> obtenerMateriasDeEstudiante(Long estudianteId); // Método para obtener las materias de un estudiante por su ID
    ...
    List<EstudianteDTO> obtenerEstudiantesPorCurso(String materia);
}